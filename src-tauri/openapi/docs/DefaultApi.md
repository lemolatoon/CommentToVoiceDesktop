...
> delete_preset_delete_preset_post(id)
Delete Preset
...
> import_user_dict_words_import_user_dict_post(_override, request_body)
...
> crate::models::SupportedDevicesInfo supported_devices_supported_devices_get(core_version)
Supported Devices
